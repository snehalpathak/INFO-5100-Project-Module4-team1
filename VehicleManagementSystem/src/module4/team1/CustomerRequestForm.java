...
public class CustomerRequestForm extends JFrame {
	...
	private JLabel lblLastname, lblFirstName, lblEmail, lblContactNumber, lblCarDetails, lblDealerDetails, lblMessage,
			lblPeopleInterestedIn;
	...
	private void addCarAndDealerDetails() {
		txtCarDetails.setText("Civic");
		txtDealerDetails.setText("honda");
	}
	...
	private void addActionListener() {
		btnSubmit.addActionListener(ae -> addUserDetails());
	}

	private void addUserDetails() {
		 User user = new User(txtFirstName.toString(), txtLastName.toString(), txtEmail.toString(), txtContactNumber.toString(), txtMessage.toString());
		 UserOperations.getInstance().addUserDetailsToDB(user);
	 }
	...
	private void createHorizontalGroup(GroupLayout gl_contentPane) {
		gl_contentPane.setHorizontalGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING).addGroup(gl_contentPane
				...
				.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING).addGroup(gl_contentPane
						.createSequentialGroup().addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING, false)
										.addComponent(lblCarDetails, Alignment.LEADING, GroupLayout.DEFAULT_SIZE,
												GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
										.addComponent(lblContactNumber, Alignment.LEADING, GroupLayout.DEFAULT_SIZE,
												GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
				...
				.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING).addGroup(Alignment.LEADING,
						...
						.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING, false).addComponent(txtMessage)
								.addComponent(txtContactNumber, GroupLayout.PREFERRED_SIZE, 153,
										GroupLayout.PREFERRED_SIZE)
				...
				.addGroup(gl_contentPane.createSequentialGroup().addGap(19)
						.addComponent(lblPeopleInterestedIn, GroupLayout.PREFERRED_SIZE, 237,
								GroupLayout.PREFERRED_SIZE)
	...
	private void createVerticalGroup(GroupLayout gl_contentPane) {
		gl_contentPane.setVerticalGroup(gl_contentPane.createParallelGroup(Alignment.LEADING).addGroup(gl_contentPane
				...
				.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE).addComponent(lblFirstName)
				...
				.addGap(26)
				.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE).addComponent(lblContactNumber)
						.addComponent(txtContactNumber, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
								GroupLayout.PREFERRED_SIZE))
				.addGap(18)
				.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE).addComponent(lblCarDetails)
						.addComponent(txtDealerDetails, GroupLayout.PREFERRED_SIZE, 34, GroupLayout.PREFERRED_SIZE))
				.addGap(20)
				.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE).addComponent(lblDealerDetails)
						.addComponent(txtCarDetails, GroupLayout.PREFERRED_SIZE, 38, GroupLayout.PREFERRED_SIZE))
				.addGap(27)
				.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING).addComponent(lblMessage)
						.addComponent(txtMessage, GroupLayout.PREFERRED_SIZE, 53, GroupLayout.PREFERRED_SIZE))
				.addGap(71).addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING).addComponent(btnSubmit)
